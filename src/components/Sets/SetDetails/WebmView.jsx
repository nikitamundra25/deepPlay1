...
class WebmView extends Component {
  ...
  componentDidUpdate = ({
    ...
    if (vid) {
      ...
      console.log("parseFloat(videoMaxDuration - vid.currentTime)",parseInt(videoMaxDuration - vid.currentTime))
      console.log("Condition",parseFloat(videoMaxDuration - vid.currentTime) <= 0.2)
