          ...
          <Row>
            ...
            <div class="about-container">
              <ol>
                ...
                <div className="h5">Welcome to DeepPlay</div>
                <p>
                  DeepPlay (“us”, “we”, or “our”) operates
                  http://www.deepplay.org (hereinafter referred to as
                  “Service”).
                </p>
                <p>
                  Our Privacy Policy governs your visit to
                  http://www.deepplay.org, and explains how we collect,
                ...
                <p>
                  <b className="font-weight-bold">SERVICE</b> means the http://www.deepplay.org website
                  operated by DeepPlay
                </p>
                <p>
                  <b className="font-weight-bold">PERSONAL DATA</b> means data about a living individual who
                  can be identified from those data (or from those and other
                  information either in our possession or likely to come into
                  our possession).
                </p>
                <p>
                  <b className="font-weight-bold">USAGE DATA</b> is data collected automatically either
                  generated by the use of Service or from Service infrastructure
                  itself (for example, the duration of a page visit).
                </p>
                <p>
                  <b className="font-weight-bold">COOKIES</b> are small files stored on your device (computer
                  or mobile device).
                </p>
                <p>
                  <b className="font-weight-bold">DATA CONTROLLER </b> means a natural or legal person who
                ...
                <p>
                  <b className="font-weight-bold">DATA PROCESSORS (OR SERVICE PROVIDERS)</b> means any
                ...
                <p>
                  <b className="font-weight-bold">DATA SUBJECT</b> is any living individual who is the
                  subject of Personal Data.
                </p>
                <p>
                  <b className="font-weight-bold">THE USER</b> is the individual using our Service. The User
                ...
                <div>
                  <b className="h5">Personal Data</b>
                </div>
                <p>
                ...
                <p>
                  ...
                  unsubscribe link or by emailing at hello@deepplay.org.
                </p>
                <div>
                  <b className="h5 font-weight-bold">Usage Data</b>
                </div>
                <p>
                ...
                <div>
                  <b className="h5 font-weight-bold">Location Data</b>
                </div>
                <p>
                ...
                <div>
                  <b className="h5 font-weight-bold">Tracking Cookies Data</b>
                </div>
                <p>
                ...
                <p>
                  <ol>
                    <li type="a">
                      <b className="font-weight-bold">Session Cookies:</b> We use Session Cookies to operate our
                      Service.
                  </li>
                    <li type="a">
                      <b className="font-weight-bold">Preference Cookies:</b> We use Preference Cookies to
                      remember your preferences and various settings.
                  </li>
                    <li type="a">
                      <b className="font-weight-bold">Security Cookies:</b> We use Security Cookies for security
                      purposes.
                  </li>
                    <li type="a">
                      <b className="font-weight-bold">Advertising Cookies:</b> Advertising Cookies are used to
                ...
                <div>
                  <b className="h5 font-weight-bold">Other Data</b>
                </div>
                <p>
                ...
                <p>DeepPlay uses the collected data for various purposes:</p>
                <p>
                  <ul type="bullat">
                ...
                <p>
                  DeepPlay will take all the steps reasonably necessary to
                ...
                <p>
                  <ol>
                    <li type="a">
                      <b className=" font-weight-bold"> Disclosure for Law Enforcement:</b>
                      <p>
                    ...
                    <li type="a">
                      <b className=" font-weight-bold"> Business Transaction:</b>
                      <p>
                    ...
                    <li type="a">
                      <b className=" font-weight-bold"> Other cases. We may disclose your information also:</b>
                      <ol>
                        <li type="a"> to our subsidiaries and affiliates.</li>
                        <li type="a">
                          {" "}
                        ...
                        <li type="a"> with your consent in any other cases.</li>
                        <li type="a">
                          {" "}
                ...
                <b className="h5 font-weight-bold d-block">
                  Security of Data{" "}
                </b>
                ...
                <p>
                  ...
                  email us at hello@deepplay.org.
                </p>
                <p>
                ...
                <ol>
                  <li type="a">users can visit our site anonymously. </li>
                  <li type="a">
                  ...
                  <li type="a">
                    ...
                    emailing us at hello@deepplay.org.{" "}
                  </li>
                </ol>
                ...
                <br />
                <b className="font-weight-bold">GitHub</b>
                ...
                <br />
                <b className="font-weight-bold">GitLab CI/CD</b>
                ...
                <b className="font-weight-bold">Google AdSense DoubleClick Cookie </b>
                <p>
                ...
                <b className="font-weight-bold">Bing Ads </b>
                <p>
                ...
                <b className="font-weight-bold">AdMob by Google</b>
                ...
                <p>
                  DeepPlay uses remarketing services to advertise on third party
                ...
                <p>By email: hello@deepplay.org</p>
                <p>
                  By visiting this page on our website:
                  http://www.deepplay.org/contact.
                </p>
              </ol>
            </div>
          </Row>
