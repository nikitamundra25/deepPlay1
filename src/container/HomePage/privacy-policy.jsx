        ...
        <Row className="terms-service-body">
          <div className="container">
            ...
            <ol>
              ...
              <p>
                DeepPlay (“us”, “we”, or “our”) operates http://www.deepplay.org
                (hereinafter referred to as “Service”).
              </p>
              <p>
                Our Privacy Policy governs your visit to
                http://www.deepplay.org, and explains how we collect, safeguard
              ...
              <p>
                <b className="font-weight-bold">SERVICE</b> means the
                http://www.deepplay.org website operated by DeepPlay
              </p>
              <p>
                <b className="font-weight-bold">PERSONAL DATA</b> means data
                about a living individual who can be identified from those data
                (or from those and other information either in our possession or
                likely to come into our possession).
              </p>
              <p>
                <b className="font-weight-bold">USAGE DATA</b> is data collected
                automatically either generated by the use of Service or from
                Service infrastructure itself (for example, the duration of a
                page visit).
              </p>
              <p>
                <b className="font-weight-bold">COOKIES</b> are small files
                stored on your device (computer or mobile device).
              </p>
              <p>
                <b className="font-weight-bold">DATA CONTROLLER </b> means a
              ...
              <p>
                <b className="font-weight-bold">DATA SUBJECT</b> is any living
                individual who is the subject of Personal Data.
              </p>
              <p>
                <b className="font-weight-bold">THE USER</b> is the individual
              ...
              <p>
                <ol>
                  <li type="a">
                    <b className="font-weight-bold">Session Cookies:</b> We use
                    Session Cookies to operate our Service.
                  </li>
                  <li type="a">
                    <b className="font-weight-bold">Preference Cookies:</b> We
                    use Preference Cookies to remember your preferences and
                    various settings.
                  </li>
                  <li type="a">
                    <b className="font-weight-bold">Security Cookies:</b> We use
                    Security Cookies for security purposes.
                  </li>
                  <li type="a">
                    <b className="font-weight-bold">Advertising Cookies:</b>{" "}
              ...
              <div>
                <b className="h5 font-weight-bold">Use of Data</b>
              </div>
              ...
              <p>
                DeepPlay will take all the steps reasonably necessary to ensure
              ...
              <b className="h5 font-weight-bold d-block">Security of Data </b>
              <p>
